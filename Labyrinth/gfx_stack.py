...
screen: pygame.Surface # Fenster-Objekt in welches die Leinwand gezeichnet wird
surface: pygame.Surface # Leinwand-Objekt zum Zeichnen
clock: pygame.time.Clock # Timer-Objekt
